...
We will update this document as this conversation continues and as the Solidity development proceeds; an updated version of the paper can always be found \href{https://github.com/burnable-tech/foundry-design/releases}{here}. Any version of this document not found at this link should not be considered final or public.
