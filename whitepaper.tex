...
This is the first time this design has been shared with the public, so there may be crucial flaws or overlooked corner-cases we have not considered. We are welcoming feedback via Github Issues \href{https://github.com/burnable-tech/foundry-design/issues}{here}. We will update this document as this conversation continues and as the Solidity development proceeds; an updated version of the paper can always be found \href{https://github.com/burnable-tech/foundry-design/releases}{here}. If you didn't get this paper from this link, please check that the version number at the top of this document is the latest!
